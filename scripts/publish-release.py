...
[Installation guide](https://github.com/{REPOSITORY}/blob/v{version}/INSTALL_WITH_CODEX.md) · [Verification and limits](https://github.com/{REPOSITORY}/blob/v{version}/VERIFICATION.md)
